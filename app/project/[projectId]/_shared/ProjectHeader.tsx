...
const OnSave= async()=>{
  ...
  const result = await axios.put('/app/api/project',{
...
return (
    <div className='flex items-center justify-between p-4 shadow'>
       <div className="flex gap-2 items-center">
              ...
              <Button onClick={OnSave} disabled={loading} variant={'destructive'}> {loading?<Loader2 className='animate-spin'/>: <Save/>} Save</Button>
    </div>
  )
}
